    ...
    return(
        ...
        <div data-aos="fade-up" data-aos-duration="200" data-aos-easing="ease-in-cubic" className="border border-[var(--tag)] rounded-xs py-4 pb-5 px-4 h-fit">
           ...
           <div className="flex flex-col gap-6">
            ...
            <BulletPointCard aosDelay="100" header="Real-Time Fetching" paragraph="When you hit search, GitPeek sends a live request to GitHub and retrieves public details like avatar, name, bio, location, and repository stats." />
