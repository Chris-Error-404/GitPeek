    ...
    return(
        <>
            <footer className="mt-2 px-4 py-4 flex flex-col-reverse lg:flex-row items-center justify-between  border-t border-t-[var(--lighter-tag)] dark:border-t-[var(--tag)] lg:gap-0 gap-4">
                <p className="font-meduim text-[var(--background)] dark:text-[var(--foreground)] text-center text-xs">&copy; <a href="https://github.com/Chris-Error-404/GitPeek?tab=GPL-3.0-1-ov-file">Typical Developer</a>  | All Rights Reserved</p>
